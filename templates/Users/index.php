        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('AdrElectonique') ?></th>
                    <th><?= $this->Paginator->sort('DateNaissance') ?></th>
                    <th><?= $this->Paginator->sort('AdressePostale') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= h($user->prenom) ?></td>
                    <td><?= h($user->sexe) ?></td>
                    <td><?= h($user->AdrElectonique) ?></td>
                    <td><?= h($user->DateNaissance) ?></td>
                    <td><?= h($user->AdressePostale) ?></td>
